...
**Transliteración:** *phainómenon*
**Significado general:** fenómeno, aquello que aparece, lo que se muestra, lo que se manifiesta.
...
**Significados posibles:** palabra, discurso, razón, estudio, tratado.
...
“estudio racional de lo que se manifiesta”
o
“descripción rigurosa de aquello que aparece a la conciencia”.
...
1. Primero se afirma que filosofía y arte comparten una tarea crítica.
2. Luego se dice que juntas ayudan a comprender la construcción de la subjetividad.
3. Después se baja esa tesis general al caso del espacio y la arquitectura.
4. Finalmente se muestra que la fenomenología es el puente metodológico entre espacio físico y experiencia humana.
...
1. Primero afirma que la subjetividad es corporal.
2. Luego niega que el cuerpo sea solo objeto.
3. Después introduce la distinción técnica entre *Körper* y *Leib*.
4. Finalmente concluye que el cuerpo es también sujeto y fundamento de experiencia.
...
Esto significa que **no pensamos el espacio, lo sentimos con el cuerpo**:

- No entendemos una plaza porque leamos un plano, sino porque la caminamos.
- Nuestra escala física determina si una calle nos parece acogedora o agobiante.

### Conclusión aplicada

**La experiencia nace de la acción:**
Conocemos el mundo porque podemos movernos en él. “Puedo alcanzar ese objeto” es la base de nuestra comprensión del espacio.

### Elemento visual

- Imagen de una estructura espacial en forma de red o malla tridimensional deformada, con un punto luminoso interior, que sugiere perspectiva encarnada, orientación y constitución del espacio desde un centro vivido.

---

## Explicación general

Esta diapositiva profundiza la anterior. Ya no se limita a decir que el cuerpo no es solo un objeto, sino que saca una consecuencia mucho más concreta: el espacio no se comprende primero como idea abstracta, sino como experiencia corporal. Es decir, el espacio no se nos da primariamente como geometría, sino como algo que recorremos, sentimos, habitamos y medimos con nuestro cuerpo.

Ese giro es muy importante para arquitectura y para filosofía de la ciudad, porque cambia la pregunta. Ya no basta con preguntar cómo está diseñado un espacio en términos técnicos; ahora hay que preguntar cómo se vive corporalmente. El espacio deja de ser una figura neutra y pasa a ser una experiencia situada.

---

## “La corporeidad es fundamento de la experiencia”

Esta frase sigue siendo el eje de toda la diapositiva. Aquí “fundamento” significa condición básica de posibilidad. No experimentamos primero de forma puramente mental para luego añadirle el cuerpo; más bien toda experiencia ya está atravesada por nuestra corporeidad.

Eso implica que:

- la orientación depende del cuerpo;
- la cercanía y la distancia dependen del cuerpo;
- la escala depende del cuerpo;
- la acción depende del cuerpo;
- incluso la comprensión del entorno depende de lo que podemos hacer corporalmente en él.

Entonces el cuerpo no es un accidente de la experiencia, sino su base vivida.

---

## “No pensamos el espacio, lo sentimos con el cuerpo”

Esta frase es muy fuerte y conviene explicarla bien, porque no quiere decir que jamás pensemos el espacio de manera intelectual. Claro que podemos pensarlo: hacer planos, cálculos, mapas, teorías. Lo que quiere decir es que el acceso originario al espacio no es conceptual, sino corporal.

Antes de teorizar el espacio, ya lo estamos viviendo. Ya sentimos amplitud, encierro, altura, dificultad, cercanía, accesibilidad, riesgo, refugio o exposición. El cuerpo capta primero lo que luego el intelecto puede formalizar.

Fenomenológicamente, eso significa que la experiencia espacial nace en el cuerpo vivido, no en una abstracción geométrica.

---

## “No entendemos una plaza porque leamos un plano, sino porque la caminamos”

Este ejemplo es excelente porque muestra la diferencia entre representación y experiencia.

### Leer un plano
Leer un plano da información objetiva:
- medidas,
- distribución,
- accesos,
- proporciones,
...
Pero todo eso sigue siendo insuficiente si no hay experiencia vivida.

### Caminar una plaza
Caminar una plaza da algo distinto:
- ritmo del recorrido,
- percepción de apertura o vacío,
- relación con otros cuerpos,
- exposición al sol o a la sombra,
- sensación de seguridad o vulnerabilidad,
- posibilidad de detenerse, cruzar, encontrarse, descansar o salir.

Es decir, la plaza no se conoce de verdad solo por su diseño abstracto, sino por cómo el cuerpo la experimenta. La fenomenología insiste en que el sentido del espacio aparece en la vivencia corporal concreta.

Para filosofía de la ciudad, esto es central: una plaza no es solo urbanismo; es experiencia pública encarnada.

---

## “Nuestra escala física determina si una calle nos parece acogedora o agobiante”

Aquí aparece otro punto muy importante: la escala del espacio no es puramente objetiva, también es relacional. Una calle no es acogedora o agobiante solo por sus metros; lo es en relación con el cuerpo que la vive.

### Ejemplo de calle acogedora
Puede sentirse acogedora si:
- el ancho permite cercanía sin opresión,
- hay proporción entre cuerpo y entorno,
- la luz, el ruido y el flujo son habitables,
- el cuerpo puede orientarse y sentirse situado.

### Ejemplo de calle agobiante
Puede sentirse agobiante si:
- es demasiado estrecha,
- demasiado oscura,
- demasiado ruidosa,
- demasiado saturada,
- demasiado impersonal,
- o si el cuerpo se siente comprimido, vigilado o desbordado.

Esto muestra que el espacio urbano no se reduce a sus dimensiones técnicas. Su sentido aparece en la relación entre configuración espacial y experiencia corporal.

---

## “La experiencia nace de la acción”

Esta parte es decisiva, porque introduce una idea muy fenomenológica: el mundo no se nos revela solo por contemplación pasiva, sino por acción posible.

Conocemos el espacio porque podemos movernos en él, intervenir en él, recorrerlo, alcanzarlo, evitarlo, cruzarlo, rodearlo. La acción no viene después de la comprensión; en gran medida la hace posible.

Este punto se conecta mucho con fenomenología del cuerpo, especialmente con líneas que luego desarrollará Merleau-Ponty: el cuerpo no solo ocupa espacio, sino que abre un campo de posibilidades prácticas.

---

## “Puedo alcanzar ese objeto” como base de comprensión

Esta fórmula merece detenerse un poco.

No significa simplemente agarrar una cosa. Significa que entendemos el mundo desde un horizonte de posibilidades corporales:
...
Todas esas posibilidades configuran el sentido del espacio. Un escalón, una puerta, una banca, una calle o una plaza no tienen solo una forma objetiva; tienen también un sentido práctico para un cuerpo que puede o no puede hacer algo en relación con ellos.

Eso vuelve la experiencia espacial profundamente encarnada y situada.

---

## Relación con la imagen de la malla tridimensional

La imagen de la derecha parece representar un espacio deformado alrededor de un punto central. Visualmente eso sirve mucho para expresar la tesis fenomenológica: el espacio no aparece como una cuadrícula neutra e igual en todas partes, sino como un campo organizado desde una perspectiva vivida.

Ese punto central puede leerse como metáfora del cuerpo situado. Desde allí el espacio se abre, se orienta, se tensa, se organiza. No se trata solo de “un espacio externo”, sino de un espacio experimentado desde un centro de vivencia.

La deformación de la malla sugiere que el espacio humano no es puramente geométrico. Está cargado por perspectiva, proximidad, dirección y posibilidad de acción.

---

## Relación con arquitectura

Esta diapositiva aplicada a la arquitectura dice algo muy fuerte: diseñar un espacio no es solo producir una forma, sino producir condiciones de experiencia corporal.

Eso implica que la arquitectura debería preguntarse:

- cómo entra el cuerpo en el espacio;
- cómo se orienta;
- qué movimientos se facilitan o se dificultan;
- qué ritmos impone el entorno;
- cómo se siente la escala;
- qué experiencias produce el recorrido;
- cómo se articula la transición entre apertura y cierre, entre luz y sombra, entre intimidad y exposición.

Una arquitectura puramente abstracta puede ser correcta geométricamente y, aun así, fracasar humanamente. La fenomenología recuerda que el criterio último del espacio habitado pasa por la experiencia corporal de quien lo vive.

---

## Relación con filosofía de la ciudad

Para filosofía de la ciudad, esta diapositiva es especialmente útil porque deja claro que la ciudad se conoce viviéndola. No basta verla desde arriba, mapearla o calcularla. Hay que recorrerla, sentir sus escalas, experimentar sus ritmos, notar cómo el cuerpo se comporta en ella.

Eso permite pensar preguntas como estas:

- ¿Por qué ciertos barrios invitan a caminar y otros expulsan?
- ¿Por qué algunas plazas generan encuentro y otras solo tránsito?
- ¿Por qué una avenida puede sentirse hostil aunque sea eficiente?
- ¿Cómo influye la escala urbana en la experiencia de dignidad, anonimato, miedo o pertenencia?

La ciudad, entonces, no es solo infraestructura. Es campo de acción corporal y de experiencia vivida.

---

## Lectura conceptual más precisa

La lógica interna de la diapositiva va así:

1. Reafirma que la corporeidad funda la experiencia.
2. Extrae una consecuencia: el espacio se siente corporalmente.
3. Da ejemplos concretos de plaza y calle.
4. Concluye que la experiencia del mundo nace de la acción posible.

Ese orden está muy bien porque pasa de la tesis general a la aplicación concreta y luego a una formulación fenomenológica más profunda: comprender el espacio es poder actuar en él.

---

## Versión breve para exponer oralmente

Esta diapositiva desarrolla la idea de que la corporeidad es el fundamento de la experiencia espacial. No comprendemos el espacio primero como un concepto abstracto, sino como algo que sentimos y vivimos con el cuerpo. Por eso no entendemos una plaza solo leyendo un plano, sino caminándola, y nuestra propia escala física hace que una calle nos parezca acogedora o agobiante. La tesis final es que la experiencia nace de la acción: conocemos el mundo porque podemos movernos en él. Aplicado a la arquitectura y a la ciudad, esto significa que el espacio no debe pensarse solo en términos técnicos, sino desde la experiencia corporal de quienes lo habitan.

---

## Versión corta, tipo apunte

La diapositiva sostiene que no pensamos el espacio de manera originaria, sino que lo sentimos con el cuerpo. Una plaza se comprende caminándola y una calle se vive según la relación entre su escala y nuestro cuerpo. Por eso la experiencia espacial nace de la acción y de las posibilidades corporales de movernos en el mundo. En arquitectura y en filosofía de la ciudad, esto implica que el espacio no es solo forma física, sino experiencia encarnada.
...
1. Primero está la vida cotidiana en actitud natural.
2. Luego viene la reducción eidética, que busca esencias.
3. Finalmente aparece la reducción trascendental, que remite a la conciencia pura o ego trascendental.
...
1. La filosofía busca verdad, no mera opinión.
2. Esa verdad es necesaria porque apunta a la esencia.
3. La experiencia fragmentaria da aspectos parciales del objeto.
4. El método filosófico riguroso debe superar esa parcialidad.
5. La fenomenología permite ir de perfiles dispersos a estructuras esenciales.
...
1. Brentano reintroduce la idea de intencionalidad.
2. Los fenómenos mentales se distinguen por estar dirigidos a algo.
3. Creencias, deseos, expectativas y temores son ejemplos de esa estructura.
4. Esa idea prepara el terreno para Husserl y la fenomenología.
5. Gracias a ella puede pensarse la conciencia no como sustancia cerrada, sino como relación viva con el mundo.
...
1. La intencionalidad es el núcleo de la fenomenología.
2. Eso significa que toda conciencia está referida a algo.
3. Por tanto, la mente no debe imaginarse como recipiente vacío.
4. Toda vivencia implica dirección, referencia y objeto.
5. La conciencia se comprende mejor como apertura al mundo que como interioridad aislada.
...
1. La intencionalidad une conciencia y objeto.
2. Esa relación tiene dos polos correlativos:
   - la **noesis**, como acto;
   - el **noema**, como objeto tal como aparece.
3. El mismo objeto físico puede tener distintos noemas.
4. El cambio del acto o de la situación modifica el sentido del objeto.
5. Por eso la experiencia no se reduce ni al objeto solo ni al sujeto solo, sino a su correlación intencional.
...
1. salir del mundo ya explicado por teorías;
2. volver a la experiencia inmediata;
3. describir esa experiencia sin imponerle interpretaciones apresuradas;
4. captar su esencia;
5. profundizar hasta la subjetividad trascendental.
...
1. partimos del mundo teórico, lleno de explicaciones previas;
2. hacemos epoché para suspender prejuicios;
3. volvemos al mundo de la vida y adoptamos la actitud fenomenológica;
4. mediante la reducción eidética captamos la esencia;
5. mediante la reducción trascendental llegamos a la subjetividad trascendental.
...
1. primero se suspenden prejuicios;
2. luego se describe lo que aparece;
3. después se busca qué rasgos son esenciales;
4. y finalmente se integra todo en una comprensión de sentido.
...
“si cambio esto, ¿sigue siendo lo mismo?”
...
Dicho de forma más compacta:
de la suspensión,
a la descripción,
de la descripción a la esencia,
y de la esencia al sentido.
